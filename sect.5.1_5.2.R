...
#plug in corpi12_1(pi12[i]) for corr to get the one treatment case (T1 = T2) in Section 5.2
#plug in corpi12_2(pi12[i]) for corr to get the two treatment case (T1 != T2) in Section 5.2
#plug in 0 for corr to get the independent case in Section 5.1
